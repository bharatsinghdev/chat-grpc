...
export class RandomClient {
  ...
  ): Promise<proto_random_pb.InitiateResponse>;
  ...
  chatInitiate(
    ...
    callback: (
      err: grpcWeb.Error,
      response: proto_random_pb.InitiateResponse
    ) => void
  ): grpcWeb.ClientReadableStream<proto_random_pb.InitiateResponse>;
  ...
  chatInitiate(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + "/randomPackage.Random/ChatInitiate",
        request,
        metadata || {},
  ...
  sendMessage(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + "/randomPackage.Random/SendMessage",
        request,
        metadata || {},
  ...
  userStream(
    ...
    return this.client_.serverStreaming(
      this.hostname_ + "/randomPackage.Random/UserStream",
      request,
      metadata || {},
  ...
  chatStream(
    ...
    return this.client_.serverStreaming(
      this.hostname_ + "/randomPackage.Random/ChatStream",
      request,
      metadata || {},
